...
in {
  options = {
    hardware.raspberry-pi = {
        ...
        rpiConfigOpts = {
          options = {
            options = lib.mkOption {
              type = with lib.types; attrsOf (submodule configParam);
              default = {};
              example = {
                enable_gic = {
                  enable = true;
            ...
            base-dt-params = lib.mkOption {
              type = with lib.types; attrsOf (submodule dtParam);
              default = {};
              example = {
                i2c = {
                  enable = true;
              ...
              description = "Parameters to pass to the base Device Tree blob";
            };
            dt-overlays = lib.mkOption {
              type = with lib.types; attrsOf (submodule dtOverlayParam);
              default = {};
              example = {
                vc4-kms-v3d = {
                  cma-256 = {
      ...
      in
        lib.mkOption {
          type = with lib.types; attrsOf (submodule rpiConfigOpts);
        };
